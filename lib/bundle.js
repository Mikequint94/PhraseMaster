...
const gameView = new __WEBPACK_IMPORTED_MODULE_1__game_view___default.a(game, ctx).start();
gameView.drawStars(fillnum);
const phaseTwo = new __WEBPACK_IMPORTED_MODULE_2__phase2___default.a(game, ctx);
  ...
  backButton.addEventListener("click", (e) => {
    ...
    gameView = new __WEBPACK_IMPORTED_MODULE_1__game_view___default.a(game, ctx).start();
    fillnum = 0;
    target = [];
    fulltarget = [];
    phasenum = 0;
