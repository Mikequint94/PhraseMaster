...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__phase4__ = __webpack_require__(8);
...
class Translator {
  ...
  static translate(string, language) {
    ...
    $.ajax({
      ...
      translations[data.data.translations[0].translatedText.slice(-1)] = (data.data.translations[0].translatedText.slice(0, -2).replace("&#39;","'").replace("&#39;","'").replace("&#39;","'"));
    });
...
class Phase3 {
  ...
  gameplay() {
    ...
    input.addEventListener("keyup", function(e) {
      e.preventDefault();
      if (e.keyCode === 13 && myThis.redText === false && myThis.currentPhase) {
